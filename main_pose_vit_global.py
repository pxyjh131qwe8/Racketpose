...
from nets import vit_global as pose_nn
...
def train(args, params):
    ...
    if args.model_size == "b":
        model = pose_nn.vit_global_pose_b(
            num_classes=nc,
            img_size=args.input_size,
            patch_size=args.patch_size,
        ).to(device)
    elif args.model_size == "l":
        model = pose_nn.vit_global_pose_l(
            num_classes=nc,
            img_size=args.input_size,
            patch_size=args.patch_size,
        ).to(device)
...
def main():
    ...
    # model
    parser.add_argument("--model-size", type=str, default="b", choices=["b", "l"])
